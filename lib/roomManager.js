...
var RoomManager = function () {
    ...
    for (let i in this.list) {
        ...
        this.AddExit(roomProto, 1, 0, '동');
        this.AddExit(roomProto, -1, 0, '서');
        this.AddExit(roomProto, 0, 1, '남');
        this.AddExit(roomProto, 0, -1, '북');
        room.RefreshExits();
    }
...
RoomManager.prototype.AddExit = function (roomProto, x, y, keyword) {
    ...
    roomProto.exits[keyword] = newRoom.protoId;
};
